...
routes -> controller -> service -> repository -> model Why this split is used:
...
DELETE /records/{record_id} (admin) Dashboard:
...
Configure environment values (using the development template as a base):
SECRET_KEY
DATABASE_URL
CORS_ALLOW_ORIGINS
APP_ENV
